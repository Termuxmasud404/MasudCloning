...
def main_apv():
    ...
    r1 = None if IOError else requests.get('https://youtube.com/@termuxmasud-tech/Approval.txt').text
    if key1 in r1:
        Main()
        return None
    None.system('clear')
...
class Main:
    ...
    def __init__(self):
        ...
        if KHALID in ('2', '02'):
            ...
            Main()
        if KHALID in ('3', '03'):
            os.system('xdg-open https://youtube.com/@termuxmasud-tech/?ref=share')
            Main()
        if KHALID in ('4', '04'):
            os.system('xdg-open https://youtube.com/@termuxmasud-tech')
            Main()
